...
export class EditTitleDialogComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,private photos: EndPointsService,
  ...
  ngOnInit(): void {
    ...
    if(this.editData){
      ...
      this.editTitleForm.controls['thumbnailUrl'].setValue(this.editData.thumbnailUrl);
    }
  }
  createForm(){
